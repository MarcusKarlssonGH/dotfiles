...
-- Diagnostic
-- local myopts = {count=1}
-- vim.keymap.set('n', '<leader>nd', vim.diagnostic.jump(myopts), { desc = 'Go to previous [D]iagnostic message' })
-- vim.keymap.set('n', 'asd', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
